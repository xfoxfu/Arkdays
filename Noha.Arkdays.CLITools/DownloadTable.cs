    ...
    public static class DownloadTable
    {
        ...
        public static async Task Handle(Options options)
        {
            ...
            await Task.WhenAll(new[]{
                ...
                Download("campaign_table.json"),
                Download("chapter_table.json"),
                Download("char_meta_table.json"),
                Download("char_patch_table.json"),
